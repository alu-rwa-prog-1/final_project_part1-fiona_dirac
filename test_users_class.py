...
class TestStudent(unittest.TestCase):
    ...
    def test_init_find_specific_book(self, mocked_input):
    ...
    @mock.patch("users_class.input", create=True)
    def test_pos_find_specific_book(self, mocked_input):
        student = User("Fiona", "f.nganga@alustudent.com", "2020")
    ...
    @mock.patch("users_class.input", create=True)
    def test_pos_search_for_book(self, mocked_input):
        student = User("Fiona", "f.nganga@alustudent.com", "2020")
        mocked_input.side_effect = ["PYTHON"]
    ...
    @mock.patch("users_class.input", create=True)
    def test_neg_search_for_book(self, mocked_input):
        student = User("Fiona", "f.nganga@alustudent.com", "2020")
    ...
    @mock.patch("users_class.input", create=True)
    def test_pos_search_by_auth(self, mocked_input):
        student = User("Fiona", "f.nganga@alustudent.com", "2020")
